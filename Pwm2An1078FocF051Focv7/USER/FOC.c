...
//wUAlpha=Vb*4*PWM_PERIOD 
   wUBeta = (SVM_Volt->qVbeta * T);
	
	
	
//Calculation of Vref1,Vref2 and Vref3
   wX = wUBeta;
   wY = (-wUBeta + wUAlpha)/2;
   wZ = (-wUBeta - wUAlpha)/2;
  ...
  {       
    ...
    if( wY >= 0 )
        ...
        T2W = wX;
				...
				T1W=T1W/4;
				T2W=T2W/4;	
				hTimePhA=(T/8)-((T1W+T2W)/65536);
				hTimePhB=hTimePhA+(T1W/32768);
				hTimePhC=hTimePhB+(T2W/32768);
...
//   int32_t X, Y, Z,Vref1,Vref2,Vref3, wUAlpha, wUBeta;
//	

//   int32_t t1,t2;

//	
//	 uint16_t  taon=0,tbon=0,tcon=0;
//	 uint16_t  Ta=0, Tb=0, Tc=0;
//	
// 	 uint16_t Sector = 0;
//	
//   
//   wUAlpha = (SVM_Volt->qValpha * SQRT_3 )>>13;
//	
//   wUBeta =  SVM_Volt->qVbeta;

//	
//	//Calculation of Vref1,Vref2 and Vref3
//   Vref1 = wUBeta;
//   Vref2 = (-wUBeta + wUAlpha)/2;
//   Vref3 = (-wUBeta - wUAlpha)/2;

//	 // Determination of the sector									
//    if (Vref1>0) Sector = 1;													
//    if (Vref2>0) Sector = Sector+2;											
//    if (Vref3>0) Sector = Sector+4;	
...
//	 //Determination of the duty cycle taon,tbon,tcon;
//	 //assignment of the duty cycles to Ta,Tb,Tc;
...
//    }
//	
//    TIM1->CCR1 = (Ta * PWM_PERIOD)>> 15;
//    TIM1->CCR2 = (Tb * PWM_PERIOD)>> 15;
//    TIM1->CCR3 = (Tc * PWM_PERIOD)>> 15;
}
